...
public static class Juego
{
    ...
    public static void Inicializar()
    {
        ...
        //Sala 3
        salas.Add(new Sala(3, "Salida","Lograste abrir la puerta del pasillo. Tu libertad se encuentra al otro lado de esta gran puerta. Frente a vos hay un teclado numérico y una inscripción tallada que dice: " +"'No mires atrás. Solo quien capture el presente exacto hallará la salida.'", DateTime.Now.Hour * 100 + DateTime.Now.Minute)); 
    }
}
